...
excel_data = {
    ...
    # Add more from Issue Log (e.g., Raellen Rivard, Ashka Zaveri) - sample only
    "10001321": {
        "name": "Raellen Rivard",
...
st.markdown("Welcome, distinguished ICS Team member! Your exclusive guide to Policies, Payroll, Timesheets, Benefits, and more awaits. Current time: 04:05 PM EDT, October 1, 2025. 🌟")
